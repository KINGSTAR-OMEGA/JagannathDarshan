...
export const metadata: Metadata = {
    ...
    description:
        'Book Konark Sun Temple tour from Puri or Bhubaneswar. UNESCO World Heritage site visit + Sand Art Museum, Ramchandi Temple, Chandrabhaga Beach & Marine Drive. Starting ₹2,200.',
    keywords: [
    ...
    openGraph: {
        ...
        description:
            'UNESCO World Heritage Konark Sun Temple + Sand Art Museum, Ramchandi Temple, Chandrabhaga Beach, Marine Drive. Starting ₹2,200/sedan.',
        images: [{ url: '/Web_Hero.webp', width: 1200, height: 630, alt: 'Konark Sun Temple Tour Odisha' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Konark Sun Temple Tour | Starting ₹2,200',
        description: 'UNESCO World Heritage site + beach, temples & Marine Drive. Premium AC cab from Puri or Bhubaneswar.',
...
const jsonLd = {
    ...
    '@graph': [
        ...
        },
        {
            ...
            offers: [
                { '@type': 'Offer', name: 'Puri–Konark Tour (Sedan)', price: '2200', priceCurrency: 'INR', description: '10 hours, AC sedan, experienced driver' },
                { '@type': 'Offer', name: 'Puri–Konark Tour (Innova Crysta)', price: '3200', priceCurrency: 'INR', description: '10 hours, AC luxury SUV' },
            ],
        },
        {
            '@type': 'FAQPage',
            mainEntity: [
                ...
                },
                {
                    ...
                    acceptedAnswer: { '@type': 'Answer', text: 'The Puri–Konark Golden Triangle tour starts at ₹2,200 per sedan (Dzire/Etios) for 10 hours and 160 km, covering Jagannath Temple, Konark Sun Temple, Chandrabhaga Beach, and Marine Drive.' },
                },
                {
                    '@type': 'Question',
                ...
                },
                {
                    ...
                    acceptedAnswer: { '@type': 'Answer', text: 'Yes! Our popular Puri–Konark Golden Triangle package covers Jagannath Temple darshan in Puri + Konark Sun Temple + Chandrabhaga Beach in a single comfortable 10-hour tour starting at ₹2,200.' },
                },
            ],
        },
    ],
...
const itinerary = [
    { time: '08:00', label: 'Pickup', title: 'Hotel/Airport Pickup', desc: 'Our driver collects you in a comfortable AC cab from your hotel in Puri or Bhubaneswar. Begin your golden triangle journey.' },
    { time: '10:00', label: 'Temple', title: 'Jagannath Temple Darshan (Puri)', desc: 'Start with blessings from Lord Jagannath before heading to Konark. VIP darshan assistance provided.' },
    { time: '11:30', label: 'Drive', title: 'Scenic Marine Drive to Konark', desc: 'Enjoy the breathtaking coastal drive along Marine Drive — sea on one side, casuarina forests on the other.' },
    { time: '12:30', label: 'Heritage', title: 'Konark Sun Temple', desc: 'Explore the magnificent 13th-century Sun Temple. Our guide explains the astronomical significance, erotic sculptures, and Kalinga architecture.' },
    { time: '14:00', label: 'Culture', title: 'Sand Art Museum & Panchamukhi Hanuman', desc: 'Marvel at world-class sand sculptures, then visit the unique five-faced Hanuman temple nearby.' },
    { time: '15:30', label: 'Beach', title: 'Chandrabhaga Beach & Ramchandi Temple', desc: 'Relax at the pristine Chandrabhaga Beach. Visit the serene Ramchandi beachside temple at the river mouth.' },
    { time: '17:00', label: 'Return', title: 'Return Journey', desc: 'Drive back comfortably to Puri or Bhubaneswar with memories of a magnificent heritage day.' },
];
                ...
                <section className="relative min-h-[70vh] flex items-end overflow-hidden bg-[#1a0e00]">
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pb-20 pt-40 w-full">
                        ...
                        <div className="flex flex-wrap gap-4 items-center">
                            <a href="tel:+919876543210" className="text-navy-900 px-8 py-4 rounded-full text-xs font-bold uppercase tracking-widest transition-colors shadow-xl" style={{ backgroundColor: '#f59e0b' }}>
                                Book Now — ₹2,200
                            </a>
                                ...
                                <div key={i} className="relative pl-12 group">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        <div className="md:w-24 flex-shrink-0 pt-1">
                                            ...
                                            <p className="text-[0.6rem] uppercase tracking-widest font-bold" style={{ color: '#d97706' }}>{step.label}</p>
                                        </div>
                ...
                <section className="py-32 px-6 lg:px-12 bg-white">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-charcoal-500 font-light text-base">No hidden fees. Pure experience of Odisha&apos;s golden heritage.</p>
                        </div>
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-white p-10 rounded-[2rem] border border-charcoal-100 hover:border-amber-300 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                                ...
                                <div className="flex items-baseline gap-1 mb-8">
                                    <span className="text-4xl font-serif text-navy-900">₹2,200</span>
                            ...
                            <div className="p-10 rounded-[2rem] shadow-2xl relative flex flex-col border" style={{ backgroundColor: '#431407', borderColor: '#78350f' }}>
                                ...
                                <div className="flex items-baseline gap-1 mb-8">
                                    <span className="text-4xl font-serif" style={{ color: '#fbbf24' }}>₹3,200</span>
                                ...
                                <a href="tel:+919876543210" className="w-full py-4 rounded-xl text-xs font-bold uppercase tracking-[0.15em] text-navy-900 hover:opacity-90 transition-colors shadow-lg text-center block" style={{ backgroundColor: '#f59e0b' }}>Reserve Now</a>
                            </div>
                        </div>
                    </div>
                </section>
