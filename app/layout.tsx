      ...
      itemListElement: [
        {
          ...
          description: 'Jagannath Temple darshan, Puri Beach, Gundicha Temple. Starting ₹1,800.',
        },
        {
          '@type': 'ListItem',
          position: 2,
          ...
          description: 'UNESCO World Heritage Konark Sun Temple + Puri Golden Triangle. Starting ₹2,200.',
        },
        {
          '@type': 'ListItem',
          position: 3,
          ...
          description: 'Asia\'s largest lagoon — Irrawaddy dolphins, Sea Mouth, Kalijai Temple. Starting ₹3,199.',
        },
        {
          '@type': 'ListItem',
          position: 4,
          ...
          description: 'Lingaraj Temple, Khandagiri Caves, Dhauli Stupa, Nandankanan Zoo. Starting ₹1,500.',
        },
      ],
    },
  ],
